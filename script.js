let images = [
    ...
    { src: 'assets/weeknd_playboi_popular.jpg', comment: 'The Weeknd, Playboi Carti – Popular', audio: 'audio/popular.mp3' },
    { src: 'assets/d4vd.jpg', comment: 'd4vd – Feel It', audio: 'audio/feel_it.mp3' },
    { src: 'assets/tame_impala.jpg', comment: 'Tame Impala – Borderline', audio: 'audio/borderline.mp3' },
    { src: 'assets/brent.jpg', comment: 'Brent Faiyaz, Dahi, Tyler, The Creator – GRAVITY', audio: 'audio/gravity.mp3' }
];
